...
class ReorderableListViewController: UIViewController, Example {
    ...
    lazy var backingStore: [Sections: [Item]] = { initialBackingStore() }()
...
extension ReorderableListViewController {
    func configureDataSource() {
        ...
        // data source
        dataSource = UICollectionViewDiffableDataSource<Sections, Item>(collectionView: collectionView) {
...
extension ReorderableListViewController {
    func initialBackingStore() -> [Sections: [Item]] {
        var allItems = [Sections: [Item]]()
